...
func TestRoutaUnitsForUninstallIncludesDiscoveredPHPUnits(t *testing.T) {
	...
	for _, path := range []string{
		...
		filepath.Join(configHome, "systemd", "user", "default.target.wants", "routa-mysql@8.0.service"),
		filepath.Join(configHome, "systemd", "user", "default.target.wants", "routa-mysql@8.0_affiliate-platform.service"),
	...
	want := []string{"routa-caddy.service", "routa-dns.service", "routa-redis.service", "routa-mailpit.service", "routa-mariadb@11.4.service", "routa-mysql@8.0.service", "routa-mysql@8.0_affiliate-platform.service", "routa-postgres@16.service", "routa-meilisearch@1.12.service", "routa-typesense@28.service", "routa-minio@RELEASE.2026-05-01T00-00-00Z.service", "routa-php@8.3.service", "routa-php@8.4.service"}
	if !reflect.DeepEqual(got, want) {
